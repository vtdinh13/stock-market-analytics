...
def calculate_ytd_return(t1, t0):
    """ Calculate ytd return and yield returns percentage"""
    return round(((t1-t0)/t0) * 100,3)

def calculate_cagr(t1, t0, n):
    """ Calculate CAGR or annualized return and yield returns percentage"""
    return round((((t1/t0)**(1/n))-1)*100 ,3) 

def calculate_drawdown_percentage(high, low):
